...
public class AppInfo {
    ...
    private String jmustacheVersion;
    ...
    public String getJMustacheVersion() {
        return jmustacheVersion;
    }

    public void setJMustacheVersion(String jmustacheVersion) {
        this.jmustacheVersion = jmustacheVersion;
    }
    ...
    public String toString() {
        return getClass().getSimpleName() + "["
                ...
                + "jmustacheVersion=" + jmustacheVersion + ", "
